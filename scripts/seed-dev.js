...
const DEV_USERS = [
  ...
  },
  {
    ...
    usernameIsSet: true,
    name: 'John Calvin',
    bio: 'Conviction, clarity, and consistency. Hunger for truth, strength, and community.',
    verifiedStatus: 'identity',
    verifiedAt: new Date(),
    unverifiedAt: null,
  },
  ...
  },
  {
    ...
    usernameIsSet: true,
    name: 'Jack Shepherd',
    bio: 'Do the hard thing. Lead when it counts. Community means responsibility.',
    verifiedStatus: 'none',
    verifiedAt: null,
    unverifiedAt: new Date(),
  },
